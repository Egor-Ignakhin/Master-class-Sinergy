...
{
    public class PlayerSensivity : MonoBehaviour
    {
        [Tooltip("Sensitivity multiplier for moving the camera around")]
        [Range(0, 4)]public float LookSensitivity = 1f;

        [Tooltip("Additional sensitivity multiplier for WebGL")]
        private float WebglLookSensitivityMultiplier = 0.25f;

        [Tooltip("Limit to consider an input when using a trigger on a controller")]
        private float TriggerAxisThreshold = 0.4f;
        ...
        void Start()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<PlayerCharacterController, PlayerSensivity>(
                m_PlayerCharacterController, this, gameObject);
            m_GameFlowManager = FindObjectOfType<GameFlowManager>();
            DebugUtility.HandleErrorIfNullFindObject<GameFlowManager, PlayerSensivity>(m_GameFlowManager, this);
